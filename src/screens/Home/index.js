...
import { StatusBar, StyleSheet, Text, useColorScheme, View, SafeAreaView, ScrollView, TextInput, TouchableOpacity } from 'react-native'
import { colors, fonts, IC_Bakery, IC_Bakery2, IC_Drinks, IC_Fruits, IC_Search, IC_Vegetables, IL_Cauliflawer_PNG, IL_Grapes_PNG,IL_Greentea_PNG,IL_Tomato_PNG } from '../../res';
